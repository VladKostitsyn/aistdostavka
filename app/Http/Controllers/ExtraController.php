...
class ExtraController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('extras.create')->with("customFields", isset($html) ? $html : false)->with("extraGroup", $extraGroup);
    }
                ...
                $mediaItem->copy($extra, 'image');
				 ...
				 $id=$extra['id'];
					...
					DB::table('media')->where('model_id',$id)->update(['model_id'=>'0']); 
					   ...
					   $data->model_id=$id;
					   $data->model_type='App\Models\Extra';
					  $data->save();
    ...
    public function edit($id)
    {
        ...
        return view('extras.edit')->with('extra', $extra)->with("customFields", isset($html) ? $html : false)->with("extraGroup", $extraGroup);
    }
