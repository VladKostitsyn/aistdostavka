...
class Cart extends Model
{
    ...
    public function getMinimumSumOfDeliveryFreeAttribute()
    {
       $restaurant = $this->food->restaurant()->first();

        return $this->attributes['minimum_sum_of_delivery_free'] = $restaurant->minimum_sum_of_delivery_free;
    }
