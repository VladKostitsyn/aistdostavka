...
Route::get('sber-callback', 'API\SberAPIController@checkSberPay');
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('CheckUseCoupon','API\NewCoponLogick\NewCoponsLogickAPI@checkUseCoupone');
});

Route::get('VerificationPhone','API\SmsAPI\SendSmsAPI@index');
Route::get('CheckDisableSms','API\SmsAPI\SendSmsAPI@chekDisableSms');
