...
Auth::routes();
Route::get('/download', 'DownloadExcel@getDownload');
...
// Sber
Route::get('payments/sberpay/checkout', 'SberPayController@checkout');
Route::get('payments/sberpay/pay-success/{userId}/{deliveryAddressId?}/{couponCode?}/{pickUpChoice}', 'SberPayController@paySuccess');
Route::get('payments/sberpay', 'SberPayController@index');

// ModulBank https://dev.modulbank.ru/pages/viewpage.action?pageId=917528
Route::get('payments/modulbank/checkout', 'ModulbankPayController@checkout');
Route::get('payments/modulbank/pay-success/{userId}/{deliveryAddressId?}/{couponCode?}', 'ModulbankPayController@paySuccess');
Route::get('payments/modulbank', 'ModulbankPayController@index');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('foods/{id}/get-extra-group', 'FoodController@getExtraGroup');
