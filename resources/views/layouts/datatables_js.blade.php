...
<script type="text/javascript" src="{{asset('plugins/PrintPage/jquery.printPage.js') }}"></script>
        ...
        $(document).ready(function() {
            ...
            promise1.then((value) => {
                    $(".printOrder").printPage({
                        url: window.location.origin+"/orders/"+window.order,
                        attr: "href",
                    });
                $(".printOrder[data-order="+window.order+"]").click();
                console.log('true');
                window.onafterprint = function(event) { console.log('print'); };
            });
