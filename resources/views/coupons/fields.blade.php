...
<div class="form-group row ">
  ...
  <!-- Coupon Type Field -->
 <div class="form-group row ">
    {!! Form::label('coupon_type', trans("lang.coupon_type_type"),['class' => 'col-3 control-label text-right']) !!}
    <div class="col-9">
      {!! Form::select('coupon_type', ['disposable' => trans('lang.coupon_type_disposable'),'reusable' => trans('lang.coupon_type_reusable'),'disposable_one' => trans('lang.coupon_type_disposable_one')], null, ['class' => 'select2 form-control']) !!}
      <div class="form-text text-muted">{{ trans("lang.coupon_type_type_help") }}</div>
    </div>
  </div>
