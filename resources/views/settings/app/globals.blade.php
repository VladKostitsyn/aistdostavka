        ...
        <div class="card-body">
            ...
            <div class="row">
                <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
                    ...
                    <!-- sms_login Field -->
                    <div class="form-group row">
                        {!! Form::label('sms.login', trans("lang.app_setting_sms_login"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('sms_login', setting('sms_login'),  ['class' => 'form-control','placeholder'=>  '']) !!}
                            <div class="form-text text-muted">
                                {{--{{ trans("lang.app_setting_app_name_help") }}--}}
                            </div>
                        </div>
                    ...
                    <!-- sms_password Field -->
                    <div class="form-group row">
                        {!! Form::label('sms.password', trans("lang.app_setting_sms_password"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('sms_password', setting('sms_password'),  ['class' => 'form-control','placeholder'=> '' ]) !!}
                            <div class="form-text text-muted">
<!--                                {{ trans("lang.app_setting_app_name_help") }}-->
                            </div>
                        </div>
                ...
                <!-- disable_sms_verification Field -->
                    <div class="form-group row ">
                        <div class="checkbox icheck">
                            <label class="w-100 ml-2 form-check-inline">
                                {!! Form::hidden('disable_sms_verification', null) !!}
                                {!! Form::checkbox('disable_sms_verification', true, setting('disable_sms_verification')) !!}
                                <span class="ml-2">{!! trans("lang.app_setting_disable_sms_verification") !!}</span> </label>
                        </div>
                    </div>
