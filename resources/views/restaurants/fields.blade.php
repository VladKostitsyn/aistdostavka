...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- minimum_sum_of_delivery_free Field -->
    <div class="form-group row ">
        {!! Form::label('minimum_sum_of_delivery_free', trans("lang.minimum_sum_of_delivery_free"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::number('minimum_sum_of_delivery_free', null,  ['class' => 'form-control','step'=>'any','placeholder'=>  trans("lang.minimum_sum_of_delivery_free_placeholder")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.minimum_sum_of_delivery_free_help") }}
            </div>
        </div>
    </div>
    <!-- delivery_fee Field -->
    ...
    <!-- 'tinyint available_for_delivery Field' -->
    <div class="form-group row ">
        {!! Form::label('payment_mode', trans("lang.payment_mode"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('payment_mode', [trans("lang.payment_mode_default"),trans("lang.payment_mode_only_online"),trans("lang.payment_mode_only_cash")], null, ['class' => 'select2 form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.payment_mode_help") }}</div>
        </div>
    </div>
...
<!-- Description Field -->
    ...
    <!-- Work time -->
    <div class="form-group row ">
        {!! Form::label('work_time_start', trans("lang.restaurant_work_time"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-4">
            {!! Form::time('work_time_start', null, ['class' => 'form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.restaurant_work_time_start_help") }}</div>
        </div>
        <div class="col-1 text-center">-</div>
        <div class="col-4">
            {!! Form::time('work_time_end', null, ['class' => 'form-control' ]) !!}
            <div class="form-text text-muted">{{ trans("lang.restaurant_work_time_end_help") }}</div>
        </div>
    </div>
